...
import { getKYCDetails, approveKYC, rejectKYC } from '@/server/actions/admin/kyc';
          ...
          <AdminCard title="Application Info">
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-white">
                  {Math.round((Date.now() - new Date(kyc.submittedAt).getTime()) / (1000 * 60 * 60))} hours
                </span>
              </div>
            </div>
          </AdminCard>
                  ...
                  {kyc.status === 'verified' ? (
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-zinc-400">
                          Approved by {kyc.reviewedBy} on {format(new Date(kyc.reviewedAt), 'MMM dd, yyyy')}
                        </p>
                      </div>
                    </>
                  ) : (
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-zinc-400">
                          Rejected by {kyc.reviewedBy} on {format(new Date(kyc.reviewedAt), 'MMM dd, yyyy')}
                        </p>
                      </div>
                    </>
                  )}
