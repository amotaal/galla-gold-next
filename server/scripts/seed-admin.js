...
var ADMIN_EMAIL = process.env.ADMIN_EMAIL || "admin@gallagold.com";
var ADMIN_PASSWORD = process.env.ADMIN_PASSWORD;
function seedSuperAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var User, existing, hashedPassword, admin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, User.findOne({ role: "superadmin" })];
                case 2:
                    existing = _a.sent();
                    if (existing) {
                ...
                case 4:
                    ...
                    console.log("ID: ".concat(admin._id, "\n"));
